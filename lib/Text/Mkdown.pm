    ...
    (?: [*]
        (?: [*]
            (?: [*](?![\s.,!?;:*_]|$)(.+?)(?<![\s*_])[*]
                ...
                |   (?:(?![*_])(.+?)(?<![\s*_]))?[*][*]
                    #'<strong><em>1</em>3</strong>'
                )
            |   [_](?![\s.,!?;:*_]|$)(.+?)(?<![\s*_])[_]
                #'<strong><em>4</em></strong>'
                (?:(?![*_])(.+?)(?<![\s*_]))? [*][*]
                #'<strong><em>4</em>5</strong>'
            |   (?![\s.,!?;:*_]|$)(.+?)(?:(?<![\s*_])[*][*]
                #'<strong>6</strong>'
                |   (?<![*_])([*_])(?![\s.,!?;:*_]|$)(.+?)(?<![\s*_])\7
                    #'.' #'<strong>6<em>8</em></strong>'
                    (?:(?![*_])(.+?)(?<![\s*_]))?[*][*]
                    #'<strong>6<em>8</em>9</strong>'
                )
            )
        |   [_][_](?![\s.,!?;:*_]|$)(.+?)(?<![\s*_])[_][_]
            #'<em><strong>10</strong></em>'
            (?:(?![*_])(.+?)(?<![\s*_]))?[*]
            #'<em><strong>10</strong>11</em>'
        |   (?![\s.,!?;:*_]|$)(.+?)(?:(?<![\s*_])[*]
            #'<em>12</em>'
            |   (?<![*_])([*][*]|[_][_])(?![\s.,!?;:*_]|$)(.+?)(?<![\s*_])\13
                #'.' #'<em>12<strong>14</strong></em>'
                (?:(?![*_])(.+?)(?<![\s*_]))?[*]
                #'<em>12<strong>14</strong>15</em>'
            )
        )
    |   [_]
        (?: [_]
            (?: [_](?![\s.,!?;:*_]|$)(.+?)(?<![\s*_])[_]
                ...
                (?: [_](?![*_])(.+?)(?<![\s*_])[_]
                    #'<em><strong>16</strong>17</em>'
                |   (?:(?![*_])(.+?)(?<![\s*_]))?[_][_]
                    #'<strong><em>16</em>18</strong>'
                )
            |   [*](?![\s.,!?;:*_]|$)(.+?)(?<![\s*_])[*]
                #'<strong><em>19</em></strong>'
                (?:(?![*_])(.+?)(?<![\s*_]))?[_][_]
                #'<strong><em>19</em>20</strong>'
            |   (?![\s.,!?;:*_]|$)(.+?)(?:(?<![\s*_])[_][_]
                #'<strong>21</strong>'
                |   (?<![*_])([*_])(?![\s.,!?;:*_]|$)(.+?)(?<![\s*_])\22
                    #'.' #'<strong>21<em>23</em></strong>'
                    (?:(?![*_])(.+?)(?<![\s*_]))?[_][_]
                    #'<strong>21<em>23</em>24</strong>'
                )
            )
        |   [*][*](?![\s.,!?;:*_]|$)(.+?)(?<![\s*_])[*][*]
            #'<em><strong>25</strong></em>'
            (?:(?![*_])(.+?)(?<![\s*_]))?[_]
            #'<em><strong>25</strong>26</em>'
        |   (?![\s.,!?;:*_]|$)(.+?)(?:(?<![\s*_])[_]
            #'<em>27</em>'
            |   (?<![*_])([_][_]|[*][*])(?![\s.,!?;:*_]|$)(.+?)(?<![\s*_])\28
                #'.' #'<em>27<strong>29</strong></em>'
                (?: (?![*_])(.+?)(?<![\s*_]))?[_]
                #'<em>27<strong>29</strong>30</em>'
            )
        )
    )
    (?![*_])
